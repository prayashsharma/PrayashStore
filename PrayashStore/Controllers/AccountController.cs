    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ViewBag.Header = "Confirmation Email Sent.";
                    ViewBag.Message = "Please check your email and confirm your email address.";
                    return View("Info");
                }
                AddErrors(result);
            }
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ViewBag.Header = "Change Password Confirmation";
                    ViewBag.Message = "Your password has successfully changed.";
                    return View("Info");
                }
                AddErrors(result);
            }
